...
public interface IMVC_ControllerDAO<DTO>
{
    ...
    String Create(@Valid @ModelAttribute DTO dto, RedirectAttributes redirectAttributes);
    String ShowEdit(@PathVariable Long id, Model model);
    String Update(@PathVariable Long id, @ModelAttribute DTO dto, RedirectAttributes redirectAttributes);
